...
const Articles = () => {
    ...
    const handleDeleteClick = async (id) => {
        const result = await Swal.fire({
            ...
            text: "Anda tidak bisa memulihkan artikel yang sudah dihapus",
            icon: 'warning',
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            Toast.fire({
                icon: 'error',
                title: 'Gagal Mengubah Informasi'
            });
        }
    };
            ...
            <div className="bg-blue-600 text-white">
                <div className="flex min-h-screen">
                    ...
                    <div className="flex-1 flex flex-col">
                        <Header />
                        <div className="min-h-screen bg-gradient-to-br from-blue-500 to-white py-8">
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div className="flex justify-between items-center mb-8">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center px-4 py-2 bg-white text-blue-600 rounded-lg hover:bg-blue-100 transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    >
                                ...
                                {loading ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        {articles.map((article) => (
                                            <div
                                                key={article.ID}
                                                className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-200 hover:shadow-2xl hover:-translate-y-1"
                                            >
                                                <div className="p-6">
                                                    ...
                                                    <div className="flex gap-3">
                                                        <button
                                                            ...
                                                            className="flex-1 px-4 py-2 bg-red-600 text-white text-sm rounded-lg hover:bg-red-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-red-500"
                                                        >
                                                            Hapus
                                                        </button>
                                                        <button
                                                            ...
                                                            className="flex-1 px-4 py-2 bg-yellow-400 text-white text-sm rounded-lg hover:bg-yellow-500 transition duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                                        >
                                                            Edit
                                                        </button>
                                                    </div>
